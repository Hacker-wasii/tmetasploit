# tmetasploit
Bash based script that is used to install metasploit framework in termux with less data
...
* `cd`
* `wget https://raw.githubusercontent.com/Hacker-wasii/tmetasploit/master/metasploit.sh`
* `bash metasploit.sh`
```
